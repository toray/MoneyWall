...
public class MoneysApp {
	...
	public void download(Context context) {
		if (mAppChannelType == AppChannelType.QUMI) {
			...
			DevInit.download(context, name, AdType.ADLIST,
					new OnAddPointsListener() {

						@Override
						public void addPointsSucceeded(String adName,
								String packname, int point) {
							System.out
									.println("==============addPointsSucceeded============"
											+ adName + "====potint====" + point);
						}
